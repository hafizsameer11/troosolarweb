...
const BNPLFlow = () => {
    ...
    const handleCustomerTypeSelect = (type) => {
        if (type === 'commercial') {
            setFormData((prev) => ({
                ...
                auditSubtype: '',
                // BNPL commercial skips the solution picker — do not inherit Buy Now full-kit default
                productCategory: '',
            }));
    ...
    const handleAddressSubmit = async (e) => {
        ...
        try {
            ...
            const selectedSolution = isCommercial
                ? undefined
                : (formData.productCategory && formData.productCategory !== 'audit'
                    ? formData.productCategory
                    : undefined);
            ...
            const auditRequestPayload = {
                ...
                product_category: selectedSolution,
                source: 'bnpl',
                ...
                <button
                    onClick={() => {
                        if (isPartnerPath || phase === 'choose_method' || phase === 'partner_ready') {
                            setStep(11); // Back to Final Application (Financing Path is before the form)
